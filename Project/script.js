...
const hideSidebarBtn = document.getElementById("hideSidebarBtn"); // Get the hide sidebar button
const homePage = document.querySelector(".homePage"); // Get the homePage element

if (hideSidebarBtn) {
  hideSidebarBtn.addEventListener("click", () => {
    sidebar.classList.toggle("hidden");
    homePage.classList.toggle("sidebar-hidden");
  });
}
